...
class wysiwyg_widget_set_ui extends ctools_export_ui {
  ...
  function list_build_row($item, &$form_state, $operations) {
    ...
    $this->rows[$name]['data'][] = array('data' => check_plain($item->pattern), 'class' => array('ctools-export-ui-pattern'));
  ...
  function list_table_header() {
    ...
    $header[] = array('data' => t('Pattern'), 'class' => array('ctools-export-ui-pattern'));
